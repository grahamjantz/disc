...
//                 >
//                   <p className={`font-bold text-xl flex items-center bg-gray-200 text-[#242424] justify-center border rounded-full aspect-ratio aspect-ratio-1/1 w-8 h-8 p-1 ${editingPar === holeIndex ? 'bg-transparent rounded-none border-none' : ''}`}>{editingPar === holeIndex ? (
//                     <FaCheck
...
//               {holeIndex === 17 && (
//                 <tr className='bg-blue-500'>
//                   <td className="border p-2 font-bold max-w-20 w-20">{par.reduce((acc, p) => acc + p, 0)}</td> 
//                   {players.map((_, playerIndex) => {
//                     const totalScore = scores.reduce((acc, holeScores) => acc + holeScores[playerIndex], 0);
//                     const totalDiff = totalScore - par.reduce((acc, p) => acc + p, 0);
//                     return (
//                       <td key={playerIndex} className="border p-2">
